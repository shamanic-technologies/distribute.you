    ...
    <>
      ...
      <aside className="hidden md:flex w-56 bg-white border-r border-gray-200 flex-col flex-shrink-0">
        ...
        <nav className="flex-1 p-2 space-y-1">
          ...
          {((settingsItems && settingsItems.length > 0) || settingsExtra) && (
            <div className="pt-2 mt-2 border-t border-gray-100">
              <h4 className="px-3 pb-1 text-[10px] font-semibold text-gray-400 uppercase tracking-wide">Settings</h4>
      ...
      <div className="md:hidden bg-white border-b border-gray-200 px-4 py-2">
        <div className="flex items-center justify-between mb-2">
          {backHref ? (
            <Link href={backHref} className="text-[10px] text-gray-400 flex items-center gap-1">
          ...
          {title && <span className="text-xs font-semibold text-gray-800">{title}</span>}
          <div className="w-8" />
        </div>
          ...
          {items.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                className={`
                  flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[10px] whitespace-nowrap transition
                  ${isActive
