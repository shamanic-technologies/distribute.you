...
function WhatsAppGlyph() {
  return (
    <svg viewBox="0 0 32 32" fill="#082314" aria-hidden="true" className="h-6 w-6 sm:h-[30px] sm:w-[30px]">
...
export function SupportButton({ raised = false }: { raised?: boolean }) {
  ...
  return (
    <a
      ...
      className={`fixed right-4 z-30 flex h-12 w-12 items-center justify-center rounded-full bg-[#45e38e] shadow-lg transition hover:scale-105 hover:shadow-xl sm:h-14 sm:w-14 ${
