 ...
 * than a stale one.
 *
 * The LOGO is generated by brand-service (chat-service owns the image cost, and
...
export function OfferIdentityCard({ brandId, offerId }: { brandId: string; offerId: string }) {
  ...
  const logoMut = useMutation({
    mutationFn: () => generateOfferLogo(brandId, offerId),
    onSuccess: (res) => {
      seededFrom.current = res.offer;
      setError(null);
      writeOffer(res.offer);
      ...
      <div className="mt-5 flex flex-col gap-5 sm:flex-row sm:items-start">
        ...
        <div className="flex shrink-0 items-center gap-4">
          <span className="flex items-center justify-center">
            <OfferMark size="lg" logoUrl={offer?.logoUrl} />
          </span>
          <div>
            <button
              type="button"
              onClick={() => logoMut.mutate()}
              disabled={!offer || logoMut.isPending}
            ...
            >
              ...
              {offer?.logoUrl ? "Regenerate with AI" : "Generate with AI"}
            </button>
