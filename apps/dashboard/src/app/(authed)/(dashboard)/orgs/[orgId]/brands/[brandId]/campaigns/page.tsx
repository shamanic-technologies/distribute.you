...
function GenericFeaturePage({
  ...
  return (
    <div className="p-4 md:p-8">
      ...
      {/* Outreach stat cards (Impressions/Clicks/CPC GA + Meetings/CPM/Signups/
          CPS/Sales/CAC beta). Shared component → same set on all 3 surfaces. */}
      <OutreachStatCards
        stats={featureStats}
          ...
          <RevenueCostSummary
            ...
            bottomCard={
              <TopCampaignsCard
                ...
                basePath={`/orgs/${orgId}/brands/${brandId}`}
              />
            }
          />
        </div>
...
function CampaignRow({
  ...
  return (
    <Link
      href={`/orgs/${orgId}/brands/${brandId}/campaigns/${campaign.id}`}
