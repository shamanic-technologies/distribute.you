...
export default function WorkflowViewerPage() {
  ...
  return (
    <div className="flex h-full overflow-hidden bg-white">
      ...
      <aside className="hidden lg:flex w-[400px] flex-shrink-0 flex-col border-r border-gray-200 bg-gray-50/50">
        <div className="px-5 py-4 border-b border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <h1 className="font-display text-[15px] font-bold text-gray-900 truncate">
                {workflow.displayName || workflow.name}
              </h1>
              <div className="flex gap-1.5 mt-1">
                <span className="text-[11px] px-2 py-0.5 rounded-md bg-white border border-gray-200 text-gray-500 font-medium">
                  {workflow.category}
                </span>
                <span className="text-[11px] px-2 py-0.5 rounded-md bg-white border border-gray-200 text-gray-500 font-medium">
                  {workflow.channel}
        ...
        <div className="lg:hidden border-b border-gray-200 bg-white">
          ...
          >
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              <h1 className="font-display text-sm font-bold text-gray-900 truncate">
                {workflow.displayName || workflow.name}
              </h1>
