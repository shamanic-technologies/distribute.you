                ...
                <td className="px-4 py-3">
                  <div className="flex items-center gap-2">
                    <div className="min-w-0">
                      ...
                      {e?.title && (
                        <p className="text-xs text-gray-500 truncate max-w-[180px]">{e.title}</p>
                      )}
                    </div>
                    {e?.linkedinUrl && (
                ...
                <td className="px-4 py-3 hidden md:table-cell">
                  {foundAt ? (
                    <span
                      ...
                      title={new Date(foundAt).toLocaleString()}
                    >
                      {timeAgo(foundAt)}
                    </span>
                  ) : (
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-4 mb-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{e?.organizationDomain || "-"}</p>
                  </div>
                  <div>
                    <span className="text-gray-500">Industry:</span>
                    <p className="font-medium">{e?.organizationIndustry || "-"}</p>
                  </div>
                  <div>
                    <span className="text-gray-500">Size:</span>
                    <p className="font-medium">{e?.organizationSize ? `${e.organizationSize} employees` : "-"}</p>
                  </div>
                </div>
              </div>
            )}
