...
export default function BrandCreateCampaignPage() {
  ...
  // Only use sales-email-cold-outreach for now (only implemented feature)
  const featureId = "sales-email-cold-outreach";
  ...
  const { refetch: refetchCampaigns } = useAuthQuery(
    ["campaigns", { brandId }],
