...
export default function WorkflowCampaignLayout({
  ...
  params: Promise<{ orgId: string; brandId: string; sectionKey: string; id: string }>;
}) {
  ...
  return (
    <CampaignProvider campaignId={resolvedParams.id}>
      <div className="flex flex-col md:flex-row flex-1 h-full">
        <WorkflowCampaignSidebarWrapper orgId={resolvedParams.orgId} brandId={resolvedParams.brandId} sectionKey={resolvedParams.sectionKey} />
