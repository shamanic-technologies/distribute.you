...
//
// NOTE: the shape-coercing twin this app actually uses on the offer path is
// `cloneSubset` in `lib/user-fields-form.ts` (it coerces by declared kind). This
// helper stays uncoerced to avoid an import cycle with that module.
