...
const COLD_EMAIL_STEPS = [
  {
    ...
    description:
      "We read your product, figure out who your buyers are, and write the campaign. You paste a link, set a budget, and move on.",
  },
  {
    number: "#2 / Send",
    title: "We email your buyers",
    description:
      "Pre-warmed inboxes start sending the same day. Every email is personalized to the person and company.",
  },
  {
    number: "#3 / Read",
    title: "Buyer replies land in Gmail",
    description:
      "AI reads every reply. Only real buyers reach your inbox, ready to answer. The other 195 never bother you.",
  },
];
...
const PRICING_LINES = [
  ...
  ["Email generation", "$0.018"],
  ["Send via agency address", "$0.004"],
  ["Reply classifier", "$0.002"],
];
      ...
      <div className="flex min-h-[520px] min-w-0">
        <aside className="hidden md:flex w-56 flex-col border-r border-gray-200 bg-gray-50 p-5">
          ...
          <div className="rounded-lg bg-white border border-gray-200 p-3 mb-5">
            ...
            <p className="text-xs text-gray-500">Sales Cold Email Outreach</p>
          </div>
          {["Overview", "Leads", "Emails", "Campaign", "Settings"].map((item, index) => (
            <div
              key={item}
          ...
          <div className="grid lg:grid-cols-[1.25fr_0.75fr] gap-4 mb-5">
            ...
            <div className="rounded-xl border border-gray-200 bg-gray-950 p-4 text-white">
              ...
              <div className="mt-5 border-t border-gray-800 pt-4">
                ...
                <p className="text-xs text-gray-500">5 replies x $1,420</p>
              </div>
            </div>
          </div>
      ...
      <section className="pt-16 pb-10 bg-gradient-to-b from-brand-50/50 via-white to-white">
        <div className="max-w-[17.5rem] sm:max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-sm text-gray-400 mt-6">
            $25 welcome credits. No credit card. Launch in 5 minutes.
          </p>
        </div>
      ...
      <section className="py-20 bg-gray-50 border-y border-gray-100">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-12">
          ...
          <p className="text-gray-500 text-lg">
            The buyers. AI qualifies every reply before it reaches you. The noise
            stays out.
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">
              The 3 months you skip: buying tools, warming inboxes, and reading
              hundreds of replies a week.
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50 border-y border-gray-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">
              No subscription. No seats. You pay the raw sending costs, and the
              dashboard tracks what each buyer reply costs.
            </p>
          </div>
