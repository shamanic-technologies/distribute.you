...
const SALES_COLD_EMAIL: BenchmarkContent = {
  ...
  valueRecaps: [
    ...
    },
    {
      ...
      body: "$400 free credits. Cancel anytime. The dashboard tracks cost per qualified reply per product so you can double down on the winner.",
    },
  ],
  ctaPrimary: {
    headline: "Launch your first cold campaign in 60 seconds",
    sub: "$400 free credits. Drop your URL. We pick the workflow that performs best for your ICP.",
    cta: "Start free. $400 free credits",
  },
  ctaClosing: {
    headline: "Ship more. Scale what works.",
    sub: "Pick the winning workflow from this leaderboard and clone it for your brand. $400 free credits to try, cancel anytime.",
