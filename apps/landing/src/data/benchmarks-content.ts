...
const SALES_COLD_EMAIL: BenchmarkContent = {
  ...
  valueRecaps: [
    ...
    },
    {
      ...
      body: "$2 welcome credits. No subscription. The dashboard tracks cost per qualified reply per product so you can double down on the winner.",
    },
  ],
  ctaPrimary: {
    headline: "Launch your first cold campaign in 60 seconds",
    sub: "$2 welcome credits. Drop your URL. We pick the workflow that performs best for your ICP.",
...
const PR_COLD_EMAIL: BenchmarkContent = {
  ...
  ctaPrimary: {
    ...
    sub: "$2 welcome credits. Drop your URL — we find on-beat journalists and pitch on your behalf.",
    cta: "Start PR — $2 credits",
  },
  ctaClosing: {
    headline: "Skip the PR retainer",
    sub: "Clone the best-performing PR workflow from this leaderboard. Earn coverage from $2 in credits, no agency lock-in.",
    cta: "Launch on autopilot",
  },
};
...
const HIRING_COLD_EMAIL: BenchmarkContent = {
  ...
  ctaPrimary: {
    ...
    sub: "$2 welcome credits. Tell us the role — we find matching candidates and send your first batch tonight.",
    cta: "Start hiring — $2 credits",
  },
  ctaClosing: {
...
const VC_COLD_EMAIL: BenchmarkContent = {
  ...
  ctaPrimary: {
    ...
    sub: "$2 welcome credits. Tell us your stage and sector — we'll pitch the matching partners for you.",
    cta: "Start fundraise — $2 credits",
  },
  ctaClosing: {
...
const ACCELERATORS_COLD_EMAIL: BenchmarkContent = {
  whyMatters: {
    ...
    body: "Y Combinator takes ~260 of 27,000+ applicants per batch (<1%). Techstars + 200 other accelerators run on rolling cycles with much higher acceptance rates — but you have to know about them and apply on time. distribute tracks every accelerator deadline, generates a tailored cold pitch per program, and books partner calls before applications even open. From $2 in welcome credits.",
  },
  studies: [
    {
  ...
  ctaPrimary: {
    ...
    sub: "$2 welcome credits. Tell us your stage — we'll match you to the programs that fit.",
    cta: "Start applying — $2 credits",
  },
  ctaClosing: {
...
const PR_EXPERT_QUOTE: BenchmarkContent = {
  ...
  ctaPrimary: {
    ...
    sub: "$2 welcome credits. Tell us your expertise — we monitor every quote request and submit on your behalf.",
    cta: "Start quotes — $2 credits",
  },
  ctaClosing: {
    headline: "Press without a publicist.",
    sub: "Clone the best quote-outreach workflow on this leaderboard. Editorial backlinks, on autopilot, from $2.",
    cta: "Launch on autopilot",
  },
};
...
const OUTLET_DISCOVERY: BenchmarkContent = {
  ...
  ctaPrimary: {
    ...
    sub: "$2 welcome credits. Tell us your industry — we surface the outlets that actually cover your space.",
    cta: "Find outlets — $2 credits",
  },
  ctaClosing: {
...
const PRESS_KIT: BenchmarkContent = {
  ...
  ctaPrimary: {
    ...
    sub: "$2 welcome credits. Drop your URL — we build a media-ready kit and host it.",
    cta: "Generate kit — $2 credits",
  },
  ctaClosing: {
...
const AI_VISIBILITY: BenchmarkContent = {
  ...
  ctaPrimary: {
    ...
    sub: "$2 welcome credits. Drop your URL — we audit your AI visibility across 4 major answer engines.",
    cta: "Run audit — $2 credits",
  },
  ctaClosing: {
