...
(function () {
  ...
  a.addEventListener('click', function () {
    // Fire a dedicated PostHog event so support demand is countable per page.
    // posthog is loaded via the analyticsHead snippet; guard for the no-token
    // / not-yet-loaded case (best-effort analytics, not a swallowed error).
    if (window.posthog && typeof window.posthog.capture === 'function') {
      window.posthog.capture('support_whatsapp_clicked', {
        location: 'landing',
