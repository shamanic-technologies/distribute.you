...
(function () {
  var ARTICLES = [
    ...
    { url: '/cold-email-for-saas-founders/ai-cold-email-saas-founders', tag: 'AI outreach', title: 'AI cold email for SaaS founders: does it actually work?', desc: 'Per-prospect research priced on outcomes at $4-7 per click, with a 4% positive reply rate. Real campaign numbers.' },
    { url: '/cold-email-for-saas-founders/cold-email-subject-lines-saas', tag: 'Subject lines', title: 'Cold email subject lines for SaaS founders', desc: 'The patterns that drive replies. With real examples for SaaS outreach.' },
