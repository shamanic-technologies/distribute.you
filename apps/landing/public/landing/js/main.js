...
(function () {
  var ARTICLES = [
    ...
    { url: '/cold-email-for-saas-founders/cold-email-subject-lines-saas', tag: 'Subject lines', title: 'Cold email subject lines for SaaS founders', desc: 'The patterns that get more replies. With real examples for SaaS outreach.' },
...
/* ═══════════════════════════════════════════════
   ...
   price per outcome → $30 credit → budget) then hands off
...
(function () {
  ...
  /* Step 2 — price + $30 credit + budget + get started */
  function renderResult() {
    ...
    body.innerHTML = priceBlock()
      ...
      + '<button type="button" class="btn btn-p btn-lg" data-start' + (startDisabled ? ' disabled' : '') + '>Get started. $30 free →</button></div>';
